...
#define btnA A3 //shoulder left spinning
#define btnB A2 //shoulder right spinning

int btnC = 2; //undefined
int btnD = 3; //undefined
int btnE = 4; //undefined joystick btn
int btnF = 5; //undefined
int btnG = 6; //undefined
...
void loop()   /****** LOOP: RUNS CONSTANTLY ******/
{
  ...
  myData.btnF = !digitalRead(btnF);
  myData.btnG = !digitalRead(btnG);
